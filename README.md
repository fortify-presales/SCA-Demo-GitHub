# OpenText SCA Core Demo Repository

This is an intentionally vulnerable demo repository by [OpenText SCA Core](https://debricked.com) that showcases common obstacles and risks related to open source dependencies. It demonstrates how our tool helps you analyze, detect, manage and remediate open source risks.
...
### 2. Configure Your OpenText SCA Core Access Token

To enable the dependency scans with GitHub actions, set up your OpenText SCA Core Access Token as a GitHub secret:

1. Generate an Access Token through the OpenText SCA Core UI (instructions can be found [here](https://docs.debricked.com/product/administration/generate-access-token))
...
- **[.github/workflows/debricked.yml](.github/workflows/debricked.yml)**:  
  Contains the GitHub Actions workflow that triggers the OpenText SCA Core dependency scan.
- **[README.md](README.md)**:  
...
- **[libs/](libs/)**:
  Folder with insecure libraries that are scanned using file fingerprinting
  
## Additional Resources

- [OpenText SCA Core Website](https://debricked.com)
- [OpenText SCA Core Documentation](https://docs.debricked.com)
